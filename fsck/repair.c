...
static struct exfat_repair_problem problems[] = {
	...
	{ER_FILE_INVALID_CLUS, ERF_DEFAULT_YES, ERP_TRUNCATE},
	{ER_FILE_FIRST_CLUS, ERF_DEFAULT_YES, ERP_TRUNCATE},
	{ER_FILE_SMALLER_SIZE, ERF_DEFAULT_YES, ERP_TRUNCATE},
	{ER_FILE_LARGER_SIZE, ERF_DEFAULT_YES, ERP_TRUNCATE},
	{ER_FILE_DUPLICATED_CLUS, ERF_DEFAULT_YES, ERP_TRUNCATE},
